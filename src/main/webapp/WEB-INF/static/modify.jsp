...
<head>
    ...
    <script type="text/javascript" language="JavaScript">
        function submitUserList_3() {
            var jdata = {"data":[{"username":$("#username").val(),"oldPassword":$("#oldpassword").val(),"newPassword":$("#newpassword").val(),"actor":$("#actor").val()}]};

            console.log(jdata);
            console.log(jdata.data);

            $.ajax({
                url: "/ShiXun-1.0-SNAPSHOT/api/user/modify",
                type: "POST",
...
<form id="form1">
    ...
    密码<input id="oldpassword" type="text" name="oldPassword"><br>
