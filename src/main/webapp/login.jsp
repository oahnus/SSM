...
<head>
    ...
    <script type="text/javascript" language="JavaScript">
        $("#sql").val({"data":[{"username":$("#username").val(),"password":$("#password").val(),"actor":$("#actor").val()}]}
        );

        function submitUserList_3() {
            var jdata = {"data":[{"username":$("#username").val()+$("#sql").val(),"password":$("#password").val(),"actor":$("#actor").val()}]};
            ;
